...
int main() {
	...
	gebe_liste_aus(lst);
	std::cout << "\n---------------------------------------\n";
	std::cout << "Erstelle neuen Punkt an index 0 der Liste: \n";
	punkt_an_index_einfuegen(&lst, punkt_erzeugen(9, 9, 9, NULL), 0);
	std::cout << "Neue Liste: \n";
	gebe_liste_aus(lst);
	std::cout << "\n---------------------------------------\n";
	std::cout << "Erstelle neuen Punkt an in der Mitte der List: \n";
	punkt_an_index_einfuegen(&lst, punkt_erzeugen(100, 100, 100, NULL), ((int)anzahl_punkte(lst) / 2));
	std::cout << "Neue Liste: \n";
	gebe_liste_aus(lst);
	std::cout << "\n---------------------------------------\n";
	std::cout << "Erstelle neuen Punkt am Ende der Liste: \n";
	punkt_an_index_einfuegen(&lst, punkt_erzeugen(99, 99, 99, NULL), (int) anzahl_punkte(lst));
	std::cout << "Neue Liste: \n";
	gebe_liste_aus(lst);
	std::cout << "\n---------------------------------------\n";
	(void)lst3;
